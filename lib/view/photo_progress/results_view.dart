...
class _ResultsViewState extends State<ResultsView> {
  int selectButton = 0;
  List imgArr = [
    {"title": "Front Facing", "month_1_image": "", "month_2_image": ""},
    {"title": "Back Facing", "month_1_image": "", "month_2_image": ""},
    {"title": "Left Facing", "month_1_image": "", "month_2_image": ""},
    {"title": "Right Facing", "month_1_image": "", "month_2_image": ""},
  ];
  List statArr = [
    {
      "title": "Lose Weight",
                ...
                Column(
                  ...
                  children: [
                    ...
                    Row(
                      ...
                      children: [
                        Text(
                          dateToString(widget.date1, formatStr: "MMM"),
                          style: TextStyle(
                            color: TColor.gray,
                            fontSize: 16,
                            fontWeight: FontWeight.w700,
                        ...
                        Text(
                          dateToString(widget.date2, formatStr: "MMM"),
                          style: TextStyle(
                            color: TColor.gray,
                            fontSize: 16,
                            fontWeight: FontWeight.w500,
